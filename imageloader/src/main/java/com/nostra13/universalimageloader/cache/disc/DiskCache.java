...
public interface DiskCache {
	...
	/**
	 * Saves image PixelMap in disk cache.
	 *
	 * @param imageUri Original image URI
	 * @param PixelMap   Image PixelMap
	 * @return <b>true</b> - if PixelMap was saved successfully; <b>false</b> - if PixelMap wasn't saved in disk cache.
	 * @throws IOException
	 */
	boolean save(String imageUri, PixelMap PixelMap) throws IOException;

...
public interface BlockingDeque<E> extends BlockingQueue<E>, Deque<E> {
     ...
     * @param timeout how long to wait before giving up, in units of                <tt>unit</tt>
     * @param unit    a <tt>TimeUnit</tt> determining how to interpret the                <tt>timeout</tt> parameter
     * @return the head of this deque, or <tt>null</tt> if the specified waiting time elapses before an element is available
     * @throws InterruptedException if interrupted while waiting
     */
     ...
     * @param timeout how long to wait before giving up, in units of                <tt>unit</tt>
     * @param unit    a <tt>TimeUnit</tt> determining how to interpret the                <tt>timeout</tt> parameter
     * @return the tail of this deque, or <tt>null</tt> if the specified waiting time elapses before an element is available
     * @throws InterruptedException if interrupted while waiting
     */

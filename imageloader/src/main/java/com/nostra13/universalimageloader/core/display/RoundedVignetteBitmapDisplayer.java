...
public class RoundedVignetteBitmapDisplayer extends RoundedBitmapDisplayer {
	...
	protected static class RoundedVignetteDrawable extends RoundedDrawable {
		...
		RoundedVignetteDrawable(PixelMap bitmap, int cornerRadius, int margin) {
...
/*		@Override
		protected void onBoundsChange(Rect bounds) {
			...
			Point point = new Point(mRect.left + mRect.getWidth()/2, (mRect.bottom + mRect.getHeight()/2) * 1.0f / 0.7f);

			RadialShader vignette = new RadialShader(point, (mRect.left + mRect.getWidth()/2) * 1.3f,
					new float[]{0, 0, 0x7f000000}, null,
			...
			paint.setShader(vignette, Paint.ShaderType.GROUP_SHADER);
		}*/
	}
}

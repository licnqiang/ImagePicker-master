 ...
 * It can wrap any Android {@link ohos.agp.components.Component View} which can be accessed by {@link #getWrappedView()}. Wrapped
...
public interface ImageAware {
	...
	/**
	 * Returns wrapped Android {@link ohos.agp.components.Component View}. Can return <b>null</b> if no view is wrapped or view was
	 * collected by GC.<br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
	 ...
	 * ohos.agp.components.Component) ImageLoadingListener#onLoadingCancelled(String, View)}* callback.<br />
	 * Mey be called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
	 * @return <b>true</b> - if view is collected by GC and ImageLoader should stop processing this image aware view; <b>false</b> - otherwise
	 */
	boolean isCollected();
	 ...
	 */
	boolean setImageBitmap(PixelMap bitmap,float corner);
}

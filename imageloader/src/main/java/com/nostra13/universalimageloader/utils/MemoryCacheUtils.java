...
public final class MemoryCacheUtils {
	...
	/**
	 * Create fuzzy key comparator comparator
	 *
	 ...
	 * @return the list
	 */
	public static List<PixelMap> findCachedBitmapsForImageUri(String imageUri, MemoryCache memoryCache) {
		List<PixelMap> values = new ArrayList<PixelMap>();
